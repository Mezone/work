...
<div style="height: 250px;max-height: 250px;overflow-y: auto;overflow-x: hidden">
    <ul id="spjk_tree" class="ztree"></ul>
</div>
<div class="form-group" style="margin: 4px 8px 4px 0;">
    <div class="input-group" >
        ...
        <span class="input-group-btn">
            <button class="btn btn-blue" id="spjk-search-btn"><i class="fa fa-search"></i> 搜索 </button>
        </span>
    </div>
</div>
...
<SCRIPT type="text/javascript">
   ...
   var  _drawVL = new ol.layer.Vector({
    ...
    $(document).ready(function(){
        $.fn.zTree.init($("#spjk_tree"), setting, zNodes);
    });
    ...
    function onClickSpjkTree(event, treeId, treeNode, clickFlag){
