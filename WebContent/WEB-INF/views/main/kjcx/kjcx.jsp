...
<SCRIPT type="text/javascript">
   ...
   var  _drawVL = new ol.layer.Vector({
    ...
    var zNodes =[
        { id:1, pId:0, name:"综合查询", open:true},
        { id:11, pId:1, name:"单位信息"},
        { id:111, pId:11, name:"旅馆"},
        { id:112, pId:11, name:"网吧"},
        { id:113, pId:11, name:"快递"},
        { id:12, pId:1, name:"地址信息"},
        { id:121, pId:12, name:"建筑物"},
        { id:122, pId:12, name:"标准地址"},
        { id:13, pId:1, name:"其他"},
        { id:131, pId:13, name:"测试1"},
        { id:132, pId:13, name:"c测试2"},
        { id:133, pId:13, name:"测试3"}
    ];
