...
"object" == typeof module && "object" == typeof module.exports ? module.exports = P : "function" == typeof define && define.amd && define(P),
"undefined" != typeof window && expose(),
P.Constants = {
    TWO_PI: 2 * Math.PI,
    HALF_PI: Math.PI / 2,
    FITTING_COUNT: 100,
...
P.Utils.stamp = function(t) {
    var o = "_p_id_";
    return t[o] = t[o] || this._stampId++,
    t[o]
}
,
P.DomUtils = {},
P.DomUtils.create = function(t, o, e, r) {
    var n = document.createElement(t);
    return n.className = o || "",
    r && (n.id = r),
    e && e.appendChild(n),
    n
}
...
P.DomUtils.addClass = function(t, o) {
    this.hasClass(t, o) || (t.className && (t.className += " "),
    t.className += o)
}
,
...
P.DomUtils.addListener = function(t, o, e, r) {
    ...
    ,
    "addEventListener" in t ? t.addEventListener(o, i, !1) : "attachEvent" in t && t.attachEvent("on" + o, i),
    t[g] = i,
    n)
}
,
P.DomUtils.removeListener = function(t, o, e, r) {
    var n = this
      , g = P.DomUtils.getDomEventKey(o, e, r)
      , i = t[g];
    return i ? ("removeEventListener" in t ? t.removeEventListener(o, i, !1) : "detachEvent" in t && t.detachEvent("on" + o, i),
    t[g] = null ,
    n) : n
}
,
...
P.PlotUtils.getIntersectPoint = function(t, o, e, r) {
    ...
    if (e[1] == r[1]) {
        ...
        return g = s * (e[1] - t[1]) + t[0],
        i = e[1],
        [g, i]
    }
    return s = (o[0] - t[0]) / (o[1] - t[1]),
    n = (r[0] - e[0]) / (r[1] - e[1]),
...
P.PlotUtils.getAzimuth = function(t, o) {
    ...
    return o[1] >= t[1] && o[0] >= t[0] ? e = r + Math.PI : o[1] >= t[1] && o[0] < t[0] ? e = P.Constants.TWO_PI - r : o[1] < t[1] && o[0] < t[0] ? e = r : o[1] < t[1] && o[0] >= t[0] && (e = Math.PI - r),
    e
}
,
...
P.Event.PlotDrawEvent = function(t, o) {
    goog.base(this, t),
    this.feature = o
}
,
...
P.Plot.prototype = {
    ...
    setPoints: function(t) {
        this.points = t ? t : [],
        this.points.length >= 1 && this.generate()
    },
    getPoints: function() {
    ...
    updatePoint: function(t, o) {
        o >= 0 && o < this.points.length && (this.points[o] = t,
        this.generate())
    },
...
P.Plot.AttackArrow.prototype.generate = function() {
    if (!(this.getPointCount() < 2)) {
        if (2 == this.getPointCount())
            return void this.setCoordinates([this.points]);
        var t = this.getPoints()
          , o = t[0]
          , e = t[1];
        P.PlotUtils.isClockWise(t[0], t[1], t[2]) && (o = t[1],
        e = t[0]);
        ...
        p.push(s),
        c = P.PlotUtils.getQBSplinePoints(c),
        p = P.PlotUtils.getQBSplinePoints(p),
        this.setCoordinates([c.concat(g, p.reverse())])
    }
}
,
...
P.Plot.SquadCombat.prototype.generate = function() {
    ...
    if (!(2 > t)) {
        ...
        a.push(g),
        s = P.PlotUtils.getQBSplinePoints(s),
        a = P.PlotUtils.getQBSplinePoints(a),
        this.setCoordinates([s.concat(r, a.reverse())])
    }
}
,
...
P.Plot.TailedAttackArrow.prototype.generate = function() {
    ...
    if (!(2 > t)) {
        ...
        var o = this.getPoints()
          , e = o[0]
          , r = o[1];
        P.PlotUtils.isClockWise(o[0], o[1], o[2]) && (e = o[1],
        r = o[0]);
        ...
        this.setCoordinates([d.concat(i, f.reverse(), [this.swallowTailPnt, d[0]])])
    }
}
,
...
P.Plot.TailedSquadCombat.prototype.generate = function() {
    ...
    if (!(2 > t)) {
        ...
        s = P.PlotUtils.getQBSplinePoints(s),
        a = P.PlotUtils.getQBSplinePoints(a),
        this.setCoordinates([s.concat(r, a.reverse(), [e[1], s[0]])])
    }
}
,
...
P.Plot.Circle.prototype.generatePoints = function(t, o) {
    for (var e, r, n, g = [], i = 0; i <= P.Constants.FITTING_COUNT; i++)
        n = 2 * Math.PI * i / P.Constants.FITTING_COUNT,
        e = t[0] + o * Math.cos(n),
        r = t[1] + o * Math.sin(n),
        g.push([e, r]);
    return g
...
P.Plot.DoubleArrow.prototype.generate = function() {
    ...
    if (!(2 > t)) {
        ...
        var n, g;
        P.PlotUtils.isClockWise(o, e, r) ? (n = this.getArrowPoints(o, this.connPoint, this.tempPoint4, !1),
        g = this.getArrowPoints(this.connPoint, e, r, !0)) : (n = this.getArrowPoints(e, this.connPoint, r, !1),
...
P.Plot.DoubleArrow.prototype.getTempPoint4 = function(t, o, e) {
    var r, n, g, i, s = P.PlotUtils.mid(t, o), a = P.PlotUtils.distance(s, e), l = P.PlotUtils.getAngleOfThreePoints(t, s, e);
    return l < P.Constants.HALF_PI ? (n = a * Math.sin(l),
    g = a * Math.cos(l),
    i = P.PlotUtils.getThirdPoint(t, s, P.Constants.HALF_PI, n, !1),
    r = P.PlotUtils.getThirdPoint(s, i, P.Constants.HALF_PI, g, !0)) : l >= P.Constants.HALF_PI && l < Math.PI ? (n = a * Math.sin(Math.PI - l),
    g = a * Math.cos(Math.PI - l),
    i = P.PlotUtils.getThirdPoint(t, s, P.Constants.HALF_PI, n, !1),
    r = P.PlotUtils.getThirdPoint(s, i, P.Constants.HALF_PI, g, !1)) : l >= Math.PI && l < 1.5 * Math.PI ? (n = a * Math.sin(l - Math.PI),
    g = a * Math.cos(l - Math.PI),
    i = P.PlotUtils.getThirdPoint(t, s, P.Constants.HALF_PI, n, !0),
    r = P.PlotUtils.getThirdPoint(s, i, P.Constants.HALF_PI, g, !0)) : (n = a * Math.sin(2 * Math.PI - l),
...
P.Plot.Ellipse.prototype.generatePoints = function(t, o, e) {
    for (var r, n, g, i = [], s = 0; s <= P.Constants.FITTING_COUNT; s++)
        g = 2 * Math.PI * s / P.Constants.FITTING_COUNT,
        r = t[0] + o * Math.cos(g),
        n = t[1] + e * Math.sin(g),
        i.push([r, n]);
    return i
...
P.Plot.GatheringPlace = function(t) {
    goog.base(this, []),
...
P.Plot.Lune.prototype.generate = function() {
    if (!(this.getPointCount() < 2)) {
        ...
        if (P.PlotUtils.isClockWise(n, g, i))
            var c = u
              , p = l;
        else
            c = l,
...
,
P.PlotFactory = {},
P.PlotFactory.createPlot = function(t, o) {
    switch (t) {
...
P.PlotDraw.prototype.activate = function(t, o) {
    this.deactivate(),
...
P.PlotDraw.prototype.mapFirstClickHandler = function(t) {
    return this.points.push(t.coordinate),
    ...
    this.plot.fixPointCount == this.plot.getPointCount() ? void this.mapDoubleClickHandler(t) : (this.map.on("click", this.mapNextClickHandler, this),
    this.plot.freehand || this.map.on("dblclick", this.mapDoubleClickHandler, this),
    void goog.events.listen(this.mapViewport, P.Event.EventType.MOUSEMOVE, this.mapMouseMoveHandler, !1, this))
}
,
P.PlotDraw.prototype.mapMouseMoveHandler = function(t) {
    var o = map.getCoordinateFromPixel([t.offsetX, t.offsetY]);
...
P.PlotDraw.prototype.mapNextClickHandler = function(t) {
    return !this.plot.freehand && P.PlotUtils.distance(t.coordinate, this.points[this.points.length - 1]) < P.Constants.ZERO_TOLERANCE ? void 0 : (this.points.push(t.coordinate),
    this.plot.setPoints(this.points),
    this.plot.fixPointCount == this.plot.getPointCount() ? void this.mapDoubleClickHandler(t) : void (this.plot && this.plot.freehand && this.mapDoubleClickHandler(t)))
}
,
...
P.PlotDraw.prototype.disconnectEventHandlers = function() {
    ...
    goog.events.unlisten(this.mapViewport, P.Event.EventType.MOUSEMOVE, this.mapMouseMoveHandler, !1, this),
...
P.PlotDraw.prototype.deactivateMapTools = function() {
    for (var t = this.map.getInteractions(), o = t.getLength(), e = 0; o > e; e++) {
        ...
        if (r instanceof ol.interaction.DoubleClickZoom) {
            this.dblClickZoomInteraction = r,
            t.remove(r);
            break
        }
    }
...
P.PlotDraw.prototype.activateMapTools = function() {
    null  != this.dblClickZoomInteraction && (map.getInteractions().push(this.dblClickZoomInteraction),
    this.dblClickZoomInteraction = null )
}
,
    ...
    if (this.map && this.activePlot) {
        ...
        if (t)
            for (var o = P.DomUtils.createHidden("div", t, this.Constants.HELPER_HIDDEN_DIV), e = this.getControlPoints(), r = 0; r < e.length; r++) {
                ...
                P.DomUtils.create("div", this.Constants.HELPER_CONTROL_POINT_DIV, o, n),
                this.elementTable[n] = r
            }
    }
}
,
...
P.PlotEdit.prototype.destroyHelperDom = function() {
    if (this.controlPoints) {
        for (var t = 0; t < this.controlPoints.length; t++) {
            ...
            o && (P.DomUtils.removeListener(o, "mousedown", this.controlPointMouseDownHandler, this),
            P.DomUtils.removeListener(o, "mousemove", this.controlPointMouseMoveHandler2, this))
        }
        this.controlPoints = null 
    }
...
P.PlotEdit.prototype.initControlPoints = function() {
    if (this.map) {
        ...
        for (var t = this.getControlPoints(), o = 0; o < t.length; o++) {
            ...
            P.DomUtils.addListener(r, "mousedown", this.controlPointMouseDownHandler, this),
            P.DomUtils.addListener(r, "mousemove", this.controlPointMouseMoveHandler2, this)
        }
    }
}
,
...
P.PlotEdit.prototype.controlPointMouseDownHandler = function(t) {
    var o = t.target.id;
    this.activeControlPointId = o,
    goog.events.listen(this.mapViewport, P.Event.EventType.MOUSEMOVE, this.controlPointMouseMoveHandler, !1, this),
    goog.events.listen(this.mapViewport, P.Event.EventType.MOUSEUP, this.controlPointMouseUpHandler, !1, this)
}
,
...
P.PlotEdit.prototype.controlPointMouseUpHandler = function(t) {
    goog.events.unlisten(this.mapViewport, P.Event.EventType.MOUSEMOVE, this.controlPointMouseMoveHandler, !1, this),
    goog.events.unlisten(this.mapViewport, P.Event.EventType.MOUSEUP, this.controlPointMouseUpHandler, !1, this)
}
,
P.PlotEdit.prototype.activate = function(t) {
    if (t && t instanceof ol.Feature && t != this.activePlot) {
        var o = t.getGeometry();
        o.isPlot() && (this.deactivate(),
        this.activePlot = t,
...
P.PlotEdit.prototype.plotMouseOverOutHandler = function(t) {
    var o = map.forEachFeatureAtPixel(t.pixel, function(t, o) {
        return t
    });
    o && o == this.activePlot ? this.mouseOver || (this.mouseOver = !0,
    this.map.getViewport().style.cursor = "move",
    this.map.on("pointerdown", this.plotMouseDownHandler, this)) : this.mouseOver && (this.mouseOver = !1,
...
P.PlotEdit.prototype.plotMouseMoveHandler = function(t) {
    for (var o = t.coordinate, e = o[0] - this.startPoint[0], r = o[1] - this.startPoint[1], n = [], g = 0; g < this.ghostControlPoints.length; g++) {
        ...
        l.setPosition(s),
        l.setPositioning("center-center")
    }
...
P.PlotEdit.prototype.enableMapDragPan = function() {
    null  != this.mapDragPan && (this.mapDragPan.setActive(!0),
    this.mapDragPan = null )
}
;
