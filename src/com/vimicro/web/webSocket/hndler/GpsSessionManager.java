 ...
 * WebSocket Session��������
 */
public class GpsSessionManager {
	/**
	 * session�е��û���Ϣ��
	 */

	private GpsSessionManager() {

	}

	public static GpsSessionManager instance() {
		return SingletonHolder.sessionManager;
	}

	private static class SingletonHolder {
		private static GpsSessionManager sessionManager = new GpsSessionManager();
	}
